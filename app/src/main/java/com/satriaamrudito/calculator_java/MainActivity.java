package com.satriaamrudito.calculator_java;
...
import com.satriaamrudito.calculator_java.fragments.HistoryFragment;
import com.satriaamrudito.calculator_java.fragments.MainFragment;
import com.satriaamrudito.calculator_java.fragments.OperandFragment;
...
import com.satriaamrudito.calculator_java.storage.Storage;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, CalculatorActivity {
    ...
    private void askBeforePausing() {
        if (!this.mainFragment.getSaveStatus()) {
            AlertDialog alertDialog = new AlertDialog.Builder( com.satriaamrudito.calculator_java.MainActivity.this).create();
